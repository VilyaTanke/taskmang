...
export default function DashboardHeader({ user }: DashboardHeaderProps) {
  ...
  return (
    <header className="bg-gradient-to-r from-white via-blue-50 to-blue-600 shadow-lg border-b border-blue-200">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center py-6">
          ...
          <div className="flex items-center justify-between sm:justify-end gap-4">
            ...
            <button
              ...
              className="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white text-sm font-medium rounded-lg shadow-lg shadow-red-500/25 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-red-500/50 hover:scale-105"
            >
