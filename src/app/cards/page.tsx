    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden mb-6">
          <div className="px-4 sm:px-6 py-4 border-b text-gray-900 font-medium">Tarjetas</div>
          <div className="p-4">
            <div className="flex items-center space-x-4 animate-[marquee_25s_linear_infinite] whitespace-nowrap">
              <img src="/cards/mastercard_moeve_gow_bankinter.png" alt="MasterCard Moeve GOW Bankinter" className="h-12 sm:h-16 object-contain" />
              <img src="/cards/moeve_pro.png" alt="MOEVE Pro" className="h-12 sm:h-16 object-contain" />
              <img src="/cards/moeve_gow.png" alt="MOEVE GOW" className="h-12 sm:h-16 object-contain" />
              <img src="/cards/mastercard_moeve_gow_bankinter.png" alt="MasterCard Moeve GOW Bankinter" className="h-12 sm:h-16 object-contain" />
              <img src="/cards/moeve_pro.png" alt="MOEVE Pro" className="h-12 sm:h-16 object-contain" />
              <img src="/cards/moeve_gow.png" alt="MOEVE GOW" className="h-12 sm:h-16 object-contain" />
            </div>
